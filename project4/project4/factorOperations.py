...
def joinFactors(factors: List[Factor]):
    ...
    domains=factorList[0].variableDomainsDict()
    ...
    for factor in factorList:
        ...
        for variable in factor.conditionedVariables():
            if variable not in conditionedVariables:
    ...
    newCPT=Factor(unconditionedVariables,conditionedVariables,domains)
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        for assignment in newFactor.getAllPossibleAssignmentDicts():
            probabilitySum = 0
            for eliminateValue in domains[eliminationVariable]:
                assignment = assignment.copy()
                assignment[eliminationVariable] = eliminateValue
                probabilitySum += factor.getProbability(assignment)
