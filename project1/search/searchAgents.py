    ...
    def getSuccessors(self, state: Any):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                successors.append(((node, visitedCorners), action, 1))
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    "*** YOUR CODE HERE ***"
    # Number of nodes expanded: at most 15000	Grade: 2/4
    distances = []
    for x in foodGrid.asList():
        distances.append(util.manhattanDistance(position, x))
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState: pacman.GameState):
        ...
        "*** YOUR CODE HERE ***"
        # dfs cost 5324
        # bfs cost 350  ** better to use, explores level by level, better for closest dot
        # ucs cost 350  **
        # a* cost 350
